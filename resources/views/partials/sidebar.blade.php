            ...
            <ul class="list-unstyled components mb-5 text-left">
                ...
                <li id="finance" class="dropend">
                    ...
                    <ul class="collapse list-unstyled" id="financeSubmenu">
                        ...
                        {{-- FINANCE INCOME --}}
                        <li class="{{ Request::routeIs('/finance/income') ? 'active' : '' }} " id="income-finance">
                        ...
                        {{-- FINANCE EXPENSE --}}
                        <li class="{{ Request::routeIs('/finance/expense') ? 'active' : '' }} " id="expense-finance">
