...
@section("container")
    ...
    <div class="content">
        ...
        <div class="title_n_button">
            ...
            <div class="user_guide active text-center">
                ...
                <span class="user_guide_tooltip">You can make new Stock Opname here.</span>
            </div>
        </div>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="container_input_form" style="margin: 0; padding: 0;">
                        <input type="text" class="form-control input_form" id="stock_opname_date" readonly disabled>
                    </td>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            document.getElementById("stock_opname_date").value = todayDate;
        ...
        $(document).on('click', '#button_submit', function(event) {
            ...
            var stockOpnameDate = $('#stock_opname_date').val();
            var site = $('#select_site').val();
            var table = document.getElementById("table_form");
            var detailData = [];
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('/post-so-submit') }}",
                dataType: 'json',
                data: {
                    so_date: stockOpnameDate,
                    site: site,
                    detail: detailData,
                },
                success: function(response) {
