...
@section("container")
    ...
    <div class="content">
        ...
        <div style="margin-top: 20px">
            ...
            <input type="hidden" name="profile_id" id="profile_id" value="{{ $data_profile->id }}">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="container_input_form">
                        <input type="text" class="form-control" id="profile_code" value="{{ $data_profile->profile_code }}">
                    </td>
                    ...
                    <td class="container_input_form">
                        <input type="text" class="form-control" id="profile_name" placeholder="Enter name" value="{{ $data_profile->profile_name }}">
                    </td>
                </tr>
                <tr>
                    {{-- STATUS --}}
                    ...
                    <td class="container_input_form">
                        <div style="width: 75px;">
                            ...
                            @else
                                <div class="container_toggle">
                                    <input type="checkbox" class="checkbox" id="status" value="0">
                                    <label class="switch" for="status">
                                        <span class="slider"></span>
                                    </label>
                                </div>
                    ...
                    <td></td>
                    <td class="container_input_form">
                        <button class="button_submit_form" id="button_submit" style="border-radius:7px">Submit</button>
                    </td>
                </tr>
            </table>

            <div class="row input_modal mt-4">
    ...
    <script>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="toggle_enable_all d-flex">
                                            <div class="container_toggle_permission">
                                                <input type="checkbox" class="checkbox_permission master_checkbox" id="enable_all_` + formattedSubMenuName + `" value="1" checked>
        ...
        function getPermissionsOnlyMasterDataChild(data) {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('/get-permissions-only-master-data-child-edit') }}",
                dataType: 'json',
                data: {
                    submenu_id: data,
                    profile_id: profile_id
